...
export const KBtn = ({
  ...
  return (
    <div className={classNames('p-[0.5px] rounded-[4px]', backlit && 'bg-white/[0.2] shadow-xl shadow-white')}>
      <div
        className={classNames('h-6 w-6 bg-[#0A090D] rounded-[3.5px] flex items-center justify-center', className)}
        style={{
