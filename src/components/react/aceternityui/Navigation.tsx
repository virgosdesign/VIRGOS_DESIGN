...
// TODO - astro image does not work in react component. Can next/image be used in astro?
const transition = {
  type: 'spring',
  mass: 0.5,
  damping: 11.5,
  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative ">
      ...
      {active !== null && (
        ...
        >
          {active === item && (
            <div className="absolute bottom-[calc(100%_+_1.2rem)] left-1/2 transform -translate-x-1/2 pt-4">
              <motion.div
                transition={transition}
